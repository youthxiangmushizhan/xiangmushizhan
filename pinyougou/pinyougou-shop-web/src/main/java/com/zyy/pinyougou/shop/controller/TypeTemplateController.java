...
public class TypeTemplateController {
	...
	@RequestMapping("/findOneAndSpecIds/{id}")
	public TbTypeTemplate findOneAndSpecIds(@PathVariable("id") Long id) {
		return typeTemplateService.findOneAndSpecIds(id);
	}
